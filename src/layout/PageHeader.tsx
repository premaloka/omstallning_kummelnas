// import menuSq from "../assets/menu-square.svg"
// import logo from "../assets/logo-kummelnas.svg"
...
export function PageHeader({ showMenu, setShowMenu }: PageHeaderProps) {
	...
	console.log("showmenu PageHeader", showMenu)

	return (
		<div className="relative">
			<div className="flex justify-between gap-0 px-5 lg:px-12 py-3 lg:gap-20 items-center z-40 bg-kummelnas-bg sticky top-10">

				{/* MENU icon */}
				<div className={`shrink-0 ${isSmallScreen ? "w-[44px]" : "w-[140px]"}`}>
					<Button
						variant="transparent"
						size="icon"
						className="w-11 h-11 md:w-12 md:h-12 shrink-1 active:animate-ping"
						onClick={() => setShowMenu(!showMenu)}
					>
						<svg
							className="fill-current"
							xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 40 40">
							<path d="M37.9 28.5H2c-1.2 0-2.1 1-2.1 2.4v.2c0 1.3 1 2.4 2.1 2.4H38c1.2 0 2.1-1 2.1-2.4V31c0-1.3-1-2.4-2.1-2.4ZM37.9 17.5H2c-1.2 0-2.1 1-2.1 2.4v.2c0 1.3 1 2.4 2.1 2.4H38c1.2 0 2.1-1 2.1-2.4V20c0-1.3-1-2.4-2.1-2.4ZM37.9 6.5H2C1 6.5 0 7.5 0 8.9V9c0 1.3 1 2.4 2.1 2.4H38c1.2 0 2.1-1 2.1-2.4V9c0-1.3-1-2.4-2.1-2.4Z" />
						</svg>
					</Button>
				</div>
				...
				>
					<svg
						className="fill-current"
						xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 169 54">
						<g clipPath="url(#a)">
							<mask id="b" width="169" height="54" x="0" y="0" maskUnits="userSpaceOnUse">
							...
							<g mask="url(#b)">
								<path d="M168.4 0H0v54h168.4V0Z" />
							</g>
							<mask id="c" width="12" height="22" x="31" y="24" maskUnits="userSpaceOnUse">
				...
				{/* button aktiviteter */}
				{isSmallScreen ?
					<div className="flex justify-end w-[44px] shrink-0">
						<Button
							size="icon"
						>
							<Bird />
					...
					:
					<div className="flex items-center w-[140px] shrink-0 justify-end">
						<Button
							size="small"
							className=""
						>
